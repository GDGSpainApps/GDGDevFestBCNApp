...
public class SessionAlarmService extends IntentService {
    ...
    public static final String ACTION_NOTIFY_SESSION =
            "com.gdgdevfest.android.apps.devfestbcn.action.NOTIFY_SESSION";
    public static final String ACTION_SCHEDULE_STARRED_BLOCK =
            "com.gdgdevfest.android.apps.devfestbcn.action.SCHEDULE_STARRED_BLOCK";
    public static final String ACTION_SCHEDULE_ALL_STARRED_BLOCKS =
            "com.gdgdevfest.android.apps.devfestbcn.action.SCHEDULE_ALL_STARRED_BLOCKS";
    public static final String EXTRA_SESSION_START =
            "com.gdgdevfest.android.apps.devfestbcn.extra.SESSION_START";
    public static final String EXTRA_SESSION_END =
            "com.gdgdevfest.android.apps.devfestbcn.extra.SESSION_END";
    public static final String EXTRA_SESSION_ALARM_OFFSET =
            "com.gdgdevfest.android.apps.devfestbcn.extra.SESSION_ALARM_OFFSET";
    ...
    private void scheduleAlarm(final long sessionStart,
        ...
        notifIntent.setData(
                new Uri.Builder().authority("com.gdgdevfest.android.apps.devfestbcn")
